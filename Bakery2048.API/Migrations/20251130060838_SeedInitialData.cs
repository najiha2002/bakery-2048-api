        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { new Guid("10000000-0000-0000-0000-000000000005"), "#f88973ff", new DateTime(2025, 11, 30, 14, 8, 38, 612, DateTimeKind.Utc).AddTicks(6270), new DateTime(2025, 11, 30, 14, 8, 38, 612, DateTimeKind.Utc).AddTicks(6270), "🍩", true, false, "Donut", 32 },
                    { new Guid("10000000-0000-0000-0000-000000000006"), "#ed7056ff", new DateTime(2025, 11, 30, 14, 8, 38, 612, DateTimeKind.Utc).AddTicks(6280), new DateTime(2025, 11, 30, 14, 8, 38, 612, DateTimeKind.Utc).AddTicks(6280), "🍪", true, false, "Cookie", 64 },
